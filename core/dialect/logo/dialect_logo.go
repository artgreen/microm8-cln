...
func (this *DialectLogo) ExecuteDirectCommand(tl types.TokenList, ent interfaces.Interpretable, Scope *types.Algorithm, LPC *types.CodeRef) error {
	...
	// Original implementation was disabled by a leading panic; ~290 lines
	// of dead code (and the locals they used) were removed during Phase 4c.
	// Callers panic as before.
